...
substitute 'VITE_JBROWSE_INDEXES_PATH_PLACEHOLDER' "${VITE_JBROWSE_INDEXES_PATH}"
...
substitute 'VITE_METT_RELEASE_SELECTOR_ENABLED_PLACEHOLDER' "${VITE_METT_RELEASE_SELECTOR_ENABLED:-false}"
substitute 'VITE_METT_DEFAULT_RELEASE_PLACEHOLDER' "${VITE_METT_DEFAULT_RELEASE:-current}"
