...
const GeneViewerPage: React.FC = () => {
    ...
    manager.addToExtensionPoint(
        ...
        (DefaultFeatureExtra, props: Record<string, unknown>) => {
            const { model } = props as { model: any }; // Cast props to ensure model is available
            console.log('Model object:', model); // Inspect the structure

            if (model?.id === 'my_special_track') {
