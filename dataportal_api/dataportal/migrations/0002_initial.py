# Generated by Django 5.1.2 on 2024-12-11 17:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("dataportal", "0001_create_pg_trgm_extension"),
    ]

    operations = [
        migrations.CreateModel(
            name="EssentialityTag",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("type_strain", models.BooleanField(db_index=True, default=False)),
                (
                    "species",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.AutoField(primary_key=True, serialize=False)),
                ("seq_id", models.CharField(db_index=True, max_length=255)),
        ...
        migrations.AddIndex(
            model_name="gene",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["cog"], name="cog_gin_idx", opclasses=["gin_trgm_ops"]
            ),
        ),
        migrations.AddIndex(
            model_name="gene",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["kegg"], name="kegg_gin_idx", opclasses=["gin_trgm_ops"]
            ),
        ),
        migrations.AddIndex(
            model_name="gene",
