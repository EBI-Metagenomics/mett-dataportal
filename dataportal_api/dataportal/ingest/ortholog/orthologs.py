...
def _get_gene_info_for_locus(
    gff_parser: Optional[GFFParser], locus_tag: str
            ...
            for chunk in self._iter_chunks(path, chunksize=chunksize):
                ...
                for rec in chunk.to_dict(orient="records"):
                    ...
                    if not doc:
                        ...
                        species_a_acronym, species_a_name, isolate_a = _extract_species_from_locus(
                            a_id
                        )
                        species_b_acronym, species_b_name, isolate_b = _extract_species_from_locus(
                            b_id
                        )
                        ...
                        doc = {
                            ...
                            "gene_a_uniprot_id": (
                                gene_a_info.get("uniprot_id") if gene_a_info else None
                            ),
                            ...
                            "gene_b_uniprot_id": (
                                gene_b_info.get("uniprot_id") if gene_b_info else None
                            ),
                ...
                for rec in chunk.to_dict(orient="records"):
                    ...
                    for raw_protein in [raw_a, raw_b]:
                        if raw_protein:
                            ...
                            if protein_id:
                                species_acronym, species_name, isolate_name = (
                                    _extract_species_from_locus(protein_id)
                                )
