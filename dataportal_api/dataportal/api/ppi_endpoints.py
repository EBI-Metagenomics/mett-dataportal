...
async def search_ppi_interactions(request, query: PPISearchQuerySchema = Query(...)):
    ...
    if not has_search_criteria:
        raise HttpError(400, "At least one search parameter must be provided. Use protein_id or locus_tag for specific protein searches, or species_acronym for species-wide searches.")
