"""Django settings for DataPortalDatabase project.
...
# TODO DEBUG = os.getenv("DJANGO_DEBUG", False)
DEBUG = True
...
# dataportal_config_env = os.getenv("DATAPORTAL_ENV_FILE")
# if dataportal_config_env:
#     logging.warning(f"Using environment from {dataportal_config_env}")
# DATAPORTAL_CONFIG = DataPortalConfig(_env_file=dataportal_config_env)
...
DATABASES = {
    "default": {
        ...
        "NAME": "mett-db.sqlite3",  # TODO externalise
    }
}
...
UNFOLD = {
    # "SITE_ICON": lambda request: static("img/icons/mett-logo-brand.png"),
    "COLORS": {
        "primary": {
            "900": "8 80 37",
            "800": "11 99 47",
