...
class DocsConfig(BaseModel):
    docs_url: AnyHttpUrl = "https://docs.dataportaldata.org"
    portal_doi: str = "10.5281/zenodo.7684072"


class PortalConfig(BaseModel):
    url_root: AnyHttpUrl = "https://www.dataportaldata.org"


class DataPortalConfig(BaseSettings):
    ...
    class Config:
        env_prefix = "dataportal_"
        env_nested_delimiter = "__"
        # E.g. set the env var `DATAPORTAL_BIOSAMPLES__API_ROOT` to override the default
